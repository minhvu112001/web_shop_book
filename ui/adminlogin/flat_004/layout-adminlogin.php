...
<script src="<?php echo URL_UI_ADMINLOGIN_THEMES ?>layout-adminlogin_files/console_runner-19b53204114bb6697f7c32c3c848fd19.js"></script><meta charset="UTF-8"><meta name="robots" content="noindex"><link rel="canonical" href="http://codepen.io/reidark/pen/uAmey">
<script src="<?php echo URL_UI_ADMINLOGIN_THEMES ?>layout-adminlogin_files/modernizr.js" type="text/javascript"></script>
...
<link rel="stylesheet" href="<?php echo URL_UI_ADMINLOGIN_THEMES ?>layout-adminlogin_files/style.css"/>
</head><body>
<form class="login" action="<?php echo urlAdminLogin(); ?>" method="post" enctype="multipart/form-data">
...
<script src="<?php echo URL_UI_ADMINLOGIN_THEMES ?>layout-adminlogin_files/stopExecutionOnTimeout.js"></script><script src="<?php echo URL_UI_ADMINLOGIN_THEMES ?>layout-adminlogin_files/jquery.min.js"></script>
<script>
...
<script src="<?php echo URL_UI_ADMINLOGIN_THEMES ?>layout-adminlogin_files/css_live_reload_init.js"></script>
</body></html>