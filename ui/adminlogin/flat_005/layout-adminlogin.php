...
html {
  background: url(<?php echo URL_UI_ADMINLOGIN_THEMES ?>layout-adminlogin_files/background.jpg) no-repeat center center fixed;
  ...
  <div class="heading">
	...
	<?php } $_SESSION["ERROR_TEXT"] = null; ?>
      ...
      <div class="input-group input-group-lg">
       ...
       <input name="username" value="<?php echo $_SESSION['FAILED_USERNAME'];?>" class="form-control" placeholder="Tên đăng nhập" type="text">
      </div>

      <div class="input-group input-group-lg">
        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
        <input name="password" value="<?php echo $_SESSION['FAILED_PASSWORD'];?>" class="form-control" placeholder="Mật khẩu" type="password">
      </div>

     <button type="submit" class="float" style="width: 50%;">Đăng Nhập</button>
    </form>
    <p style="margin-top: 200px;color: white;">Copyright © <?php echo date('Y')?> <?php echo storeName() ;?>. All Rights Reserved.</p>
   </div>
...
<script src="/<?php echo APP;?>/x_ui/adminlogin/themes/elegant/003/layout-adminlogin_files/css_live_reload_init.js"></script>
</body></html>