...
<script src="<?php echo URL_UI?>src/css/bootstrap/less-1.7.4.min.js"></script>
		...
		<link href="<?php echo URL_UI_ADMINLOGIN_THEMES;?>layout-adminlogin_files/style.css" rel="stylesheet" type="text/css">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<div class="login-form">
					...
					<div class="head">
						<img src="<?php echo URL_UI_ADMINLOGIN_THEMES;?>layout-adminlogin_files/mem2.jpg" alt="">
