...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/style.css" rel="stylesheet">
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/theme.css" rel="stylesheet">
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/ui.css" rel="stylesheet">
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/layout.css" rel="stylesheet">
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/modernizr-2.js"></script>
  ...
  <body class="fixed-topbar theme-sdtl color-default">
    ...
    <section style="opacity: 1;">
      ...
      <div style="" class="sidebar">
        <div class="logopanel">
          <img src="<?php echo urlImgStoreLogo();?>" width="32"/><span>Admin Panel</span>
        </div>
        <div class="sidebar-inner mCS_destroyed">
          ...
          <ul class="nav nav-sidebar">
            <li class="active"><a href="<?php echo urlAdminDashboard(); ?>"><i class="icon-home"></i><span>Dashboard</span></a></li>
            <li class="nav-parent">
            ...
            <li class="">
              <a href="<?php echo urlAdminModule(); ?>"><i class="fa fa-puzzle-piece fa-fw"></i><span>Modules</span></span></a>
            </li>
            <li class="nav-parent">
            ...
            <li class="nav-parent">
              ...
              <ul class="children collapse">
                <li><a href="<?php echo urlAdminSettingEdit() ?>"><i class="fa fa-cog fa-fw"></i><span>Settings</span></a></li>
      
			      <li><a href="<?php echo urlAdminBanner() ?>"><i class="fa fa-picture-o fa-fw"></i><span>Banners</span></a>
			      </li>
			      
			      <li><a href="<?php echo urlAdminUser() ?>"><i class="fa fa-user fa-fw"></i><span>Quản Trị Viên</span></a>
			      </li>
              </ul>
            </li>
          ...
          <div style="margin-bottom: 20px;" class="sidebar-widgets">
            ...
            <ul class="folders">
              ...
              <li class="add-folder">
                <input placeholder="Folder's name..." class="form-control input-sm" type="text">
              </li>
            </ul>
          </div>
          <div style="" class="sidebar-footer clearfix">
            ...
            <a class="pull-left" href="http://themes-lab.com/make/admin/layout1/user-lockscreen.html" data-rel="tooltip" data-placement="top" data-original-title="Lockscreen">
            <i class="icon-lock"></i></a>
            <a class="pull-left btn-effect" href="http://themes-lab.com/make/admin/layout1/user-login-v1.html" data-modal="modal-1" data-rel="tooltip" data-placement="top" data-original-title="Logout">
            <i class="icon-power"></i></a>
          </div>
        <ul style="display: block; margin-bottom: 100px;" class="nav nav-horizontal nav-sidebar">
                <li><a href="#"><span class="pull-right badge badge-primary">8</span><i class="fa fa-envelope"></i><span>Mailbox</span></a></li>
                <li><a href="<?php echo urlAdminOrder(); ?>"><i class="fa fa-bar-chart"></i><span>Sales</span></a></li>
                <!--
                <li class="nav-parent active">
                  <a href="#" data-hover="dropdown" data-close-others="true" data-delay="30">
                  <i class="fa fa-list"></i> Invoicing <i class="icons-arrows-06"></i>
                  </a>
                  <ul class="dropdown-menu">
                ...
                -->
                <li><a href="#"><span class="pull-right badge badge-primary">2</span><i class="fa fa-book"></i><span>Reporting</span></a></li>
                <li><a href="<?php echo urlHome();?>" title="Trang Chủ"><i class="fa fa-home"></i><span>Home</span></a></li>
              </ul></div>
      </div>
      <!-- END SIDEBAR -->
          ...
          <div class="header-right">
            <ul class="header-menu nav navbar-nav">
              ...
              <li class="dropdown" id="language-header">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="#" data-lang="en"><img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/usa.png" alt="flag-english"> <span>English</span></a>
                  </li>
                  <li>
                    <a href="#" data-lang="es"><img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/spanish.png" alt="flag-english"> <span>Español</span></a>
                  </li>
                  <li>
                    <a href="#" data-lang="fr"><img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/french.png" alt="flag-english"> <span>Français</span></a>
                  </li>
                </ul>
              </li>
              <!-- END USER DROPDOWN -->
                  ...
                  <li class="dropdown-body">
                    <ul style="height: 220px;" class="dropdown-menu-list withScroll mCustomScrollbar _mCS_3" data-height="220"><div class="mCustomScrollBox mCS-light" id="mCSB_3" style="position:relative; height:100%; overflow:hidden; max-width:100%;"><div class="mCSB_container mCS_no_scrollbar" style="position:relative; top:0;">
                      <li class="clearfix">
                        ...
                        <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar3.png" alt="avatar 3">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar4.png" alt="avatar 4">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar5.png" alt="avatar 5">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar6.png" alt="avatar 6">
                        </span>
                        <div class="clearfix">
                          <div>
              ...
              <li class="dropdown" id="user-header">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                <img src="<?php echo userImg(); ?>" alt="user image">
                <span class="username">Xin chào, <?php echo userFullname(); ?></span>
                </a>
                <ul class="dropdown-menu">
                  <li>
                  ...
                  <li>
                    <a href="<?php echo urlAdminLogout(); ?>"><i class="icon-logout"></i><span>Logout</span></a>
                  </li>
                </ul>
              </li>
              <!-- END USER DROPDOWN -->
            ...
            <div class="chat-body current">
              ...
              <div class="chat-list">
                ...
                <ul>
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar13.png" alt="avatar">
                    </div>
                    <div class="user-details">
                  ...
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar5.png" alt="avatar">
                  ...
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar10.png" alt="avatar">
                    </div>
                    <div class="user-details">
                      <div class="user-name">Bobby Brown</div>
              ...
              <div class="chat-list">
                ...
                <ul>
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar7.png" alt="avatar">
                      <div class="pull-right badge badge-danger">3</div>
                    </div>
                    <div class="user-details">
                  ...
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar11.png" alt="avatar">
                    </div>
                    <div class="user-details">
                  ...
                  <li class="clearfix">
                    <div class="user-img">
                      <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar8.png" alt="avatar">
                    </div>
                    <div class="user-details">
...
Break security reasons.</textarea>
      ...
      <div style="height: auto;" class="morphsearch-content withScroll mCustomScrollbar _mCS_5"><div class="mCustomScrollBox mCS-light" id="mCSB_5" style="position:relative; height:100%; overflow:hidden; max-width:100%;"><div class="mCSB_container mCS_no_scrollbar" style="position:relative; top:0;">
        <div class="dummy-column user-column">
          ...
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar1_big.png" alt="Avatar 1">
            <h3>John Smith</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar2_big.png" alt="Avatar 2">
            <h3>Bod Dylan</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar3_big.png" alt="Avatar 3">
            <h3>Jenny Finlan</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar4_big.png" alt="Avatar 4">
            <h3>Harold Fox</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar5_big.png" alt="Avatar 5">
            <h3>Martin Hendrix</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar6_big.png" alt="Avatar 6">
            <h3>Paul Ferguson</h3>
          </a>
        </div>
        <div class="dummy-column">
          <h2>Articles</h2>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/1.jpg" alt="1">
            <h3>How to change webdesign?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/2.jpg" alt="2">
            <h3>News From the sky</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/3.jpg" alt="3">
            <h3>Where is the cat?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/4.jpg" alt="4">
            <h3>Just another funny story</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/5.jpg" alt="5">
            <h3>How many water we drink every day?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/6.jpg" alt="6">
        ...
        <div class="dummy-column">
          <h2>Recent</h2>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/7.jpg" alt="7">
            <h3>Design Inspiration</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/8.jpg" alt="8">
            <h3>Animals drawing</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/9.jpg" alt="9">
            <h3>Cup of tea please</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/10.jpg" alt="10">
            <h3>New application arrive</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/11.jpg" alt="11">
            <h3>Notification prettify</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/12.jpg" alt="12">
    ...
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery-1.js"></script>
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery-migrate-1.js"></script>
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery-ui-1.js"></script>
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/main-gsap.js"></script>
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap.js"></script>
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery_003.js"></script> <!-- Jquery Cookies, for theme -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery.js"></script> <!-- simulate synchronous behavior when using AJAX -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootbox.js"></script> <!-- Modal with Validation -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery_002.js"></script> <!-- Custom Scrollbar sidebar -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap-hover-dropdown.js"></script> <!-- Show Dropdown on Mouseover -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/sparkline.js"></script> <!-- Charts Sparkline -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/retina.js"></script> <!-- Retina Display -->
    <!--
	@dwp ghi chú: thư viện này làm hỏng các thẻ select gốc của boostrap
	phát hiện ra nó bằng tìm kiếm s2id_autogen1 ... id_autogen
	
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/select2.js"></script> 
    -->
    <!-- Select Inputs -->
        
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/icheck.js"></script> <!-- Checkbox & Radio Inputs -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/backstretch.js"></script> <!-- Background Image -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap-progressbar.js"></script> <!-- Animated Progress Bar -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/Chart.js"></script>
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/builder.js"></script> <!-- Theme Builder -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/sidebar_hover.js"></script> <!-- Sidebar on Hover -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/application.js"></script> <!-- Main Application Script -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/plugins.js"></script> <!-- Main Plugin Initialization Script -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/notes.js"></script> <!-- Notes Widget -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/quickview.js"></script> <!-- Chat Script -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/search.js"></script> <!-- Search Script -->
    <!-- BEGIN PAGE SCRIPT -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/layouts_api.js"></script>
    <!-- END PAGE SCRIPTS -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/layout.js"></script>
