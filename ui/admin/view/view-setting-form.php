  ...
  <div class="page-header">
    <div class="container-fluid">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo urlAdminSettingEdit();?>">Cài Đặt</a></li>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
        ...
        <form action="<?php echo $url_action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="config_book_limit" value="<?php echo $config_book_limit; ?>" placeholder="Default Items Per Page" id="input-catalog-limit" class="form-control" />
                    <?php if ($error_book_limit) { ?>
                    <div class="text-danger"><?php echo $error_book_limit; ?></div>
                    <?php } ?>
                  </div>
                </div>
                ...
                <div class="form-group required">
                 ...
                 <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="config_book_description_length" value="<?php echo $config_book_description_length; ?>" placeholder="Số kí tự mô tả(Catalog)" id="input-list-description-limit" class="form-control" />
                    <?php if ($error_book_description_length) { ?>
                    <div class="text-danger"><?php echo $error_book_description_length; ?></div>
                    <?php } ?>
                  </div>
                </div>
              </fieldset>
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-thumb-width"><span data-toggle="tooltip" title="Kích thước ảnh đại diện sản phẩm">Book Image Thumb Size</span></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-popup-width"><span data-toggle="tooltip" title="Kích thước ảnh sản phẩm popup">Book Image Popup Size</span></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-book-width"><span data-toggle="tooltip" title="Kích thước ảnh sản phẩm phân trang">Book Image List Size</span></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
                      <input type="text" name="config_image_book_width" value="<?php echo $config_image_book_width; ?>" placeholder="độ rộng" id="input-image-book-width" class="form-control" />
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="config_image_book_height" value="<?php echo $config_image_book_height; ?>" placeholder="độ cao" class="form-control" />
                    </div>
                  </div>
                  <?php if ($error_image_book) { ?>
                  <div class="text-danger"><?php echo $error_image_book; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-additional-width"><span data-toggle="tooltip" title="Kích thước ảnh thêm mới vào sản phẩm">Additional Book Image Size</span></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-image-related"><span data-toggle="tooltip" title="Kích thước ảnh sản phẩm liên quan">Related Book Image Size</span></label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-6">
