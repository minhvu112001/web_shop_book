  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-publisher" data-toggle="tooltip" title="Lưu" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $url_action; ?>" method="post" enctype="multipart/form-data" id="form-publisher" class="form-horizontal">
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-name">Tên Nhà Sản Xuất</label>
            <div class="col-sm-10">
              <input type="text" name="name" value="<?php echo $publisher_name; ?>" placeholder="Tên Nhà Sản Xuất" id="input-name" class="form-control" />
              <?php if ($error_name) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="keyword" value="<?php echo $publisher_keyword; ?>" placeholder="Keywords" id="input-keyword" class="form-control" />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10"> <a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $publisher_thumb; ?>" alt="" title="" data-placeholder="<?php echo $publisher_placeholder; ?>" /></a>
              <input type="hidden" name="image" value="<?php echo $publisher_image; ?>" id="input-image" />
            </div>
          </div>
          <div class="form-group">
