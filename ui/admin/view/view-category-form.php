  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="<?php echo urlAdminCategory(); ?>" data-toggle="tooltip" title="Hủy" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
      <ul class="breadcrumb">
      ...
      <div class="panel-body">
        <form action="<?php echo $url_action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <!--
            <li class=""><a href="#tab-design" data-toggle="tab">Thiết Kế</a></li>
            -->
          </ul>
            ...
            <div class="tab-pane active in" id="tab-general">
                <div class="tab-pane" id="language">
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-name">Tên Loại Sách</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="meta_title" value="<?php echo $category_meta_title; ?>" placeholder="Meta Title" id="input-meta-title" class="form-control" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="meta_description" rows="5" placeholder="Meta Description" id="input-meta-description" class="form-control"><?php echo $category_meta_description; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-keyword">Meta Keywords</label>
                    <div class="col-sm-10">
                      <textarea name="meta_keyword" rows="5" placeholder="Meta Keywords" id="input-meta-keyword" class="form-control"><?php echo $category_meta_keyword; ?></textarea>
                    </div>
                  </div>
                  -->
                </div>
            ...
            <div class="tab-pane fade" id="tab-data">
             ...
             -->
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="column" value="<?php echo $category_column; ?>" placeholder="Columns" id="input-column" class="form-control" />
                </div>
              </div>
               -->
              <div class="form-group">
...
$('input[name=\'path\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: '/<?php echo APP;?>/admin/category-autocomplete.php?filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
