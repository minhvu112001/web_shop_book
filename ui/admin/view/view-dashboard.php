...
<!--       <h1>Dashboard</h1> -->
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo urlAdminDashboard();?>">Dashboard</a></li>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
  ...
  <div class="tile-footer"><a href="<?php echo urlAdminOrder() ?>">Xem thêm ...</a></div>
</div>
</div>
      <div class="col-lg-3 col-md-3 col-sm-6"><div class="tile">
  ...
  <div class="tile-footer"><a href="<?php echo urlAdminCustomer() ?>">Xem thêm ...</a></div>
</div>
</div>
      <div class="col-lg-3 col-md-3 col-sm-6"><div class="tile">
