...
$('#button-upload').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			...
			$.ajax({
				url: '<?php echo urlAdminFilemanagerUpload()?>?directory=<?php echo $manager_directory; ?>',
				type: 'post',		
				dataType: 'json',
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		...
		$.ajax({
			url: '<?php echo urlAdminFilemanagerFolder();?>?directory=<?php echo $manager_directory; ?>',
			type: 'post',		
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('Bạn có chắc là muốn xóa')) {
		$.ajax({
			url: '<?php echo urlAdminFilemanagerDelete()?>',
			type: 'post',		
			dataType: 'json',
