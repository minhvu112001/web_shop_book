...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
        ...
        <!-- Bootstrap core CSS -->
        <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap.css" rel="stylesheet">
        <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap-reset.css" rel="stylesheet">

        <!--Animation css-->
        <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/animate.css" rel="stylesheet">

        <!--Icon-fonts css-->
        <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/font-awesome.css" rel="stylesheet">
        <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/ionicons.css" rel="stylesheet">

        <!--Morris Chart CSS -->
        <link rel="stylesheet" href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/morris.css">

        <!-- sweet alerts -->
        <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/sweet-alert.css" rel="stylesheet">

        <!-- Custom styles for this template -->
        <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/style.css" rel="stylesheet">
        <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/helper.css" rel="stylesheet">

<script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/analytics.js" async=""></script><script>
...
<div class="pace-activity"></div></div>
        ...
        <aside tabindex="5001" style="overflow: hidden;" class="left-panel">
            ...
            <!-- brand -->
            <div class="logo">
                <a href="<?php echo urlAdminBook();?>" class="logo-expanded">
<!--                     <i class="fa icon-social-buffer"></i> -->
				   <img src="<?php echo urlImgStoreLogo();?>" width="32"/>
            ...
            <nav class="navigation">
                <ul class="list-unstyled">
                    <li class="active"><a href="<?php echo urlAdminDashboard() ?>"><i class="fa fa-dashboard fa-fw"></i> <span class="nav-label">Dashboard</span></a></li>
                    ...
                    <li><a href="<?php echo urlAdminModule(); ?>"><i class="fa fa-puzzle-piece fa-fw"></i> <span class="nav-label">Modules</span></a>
                    </li>
                ...
                <ul class="list-inline navbar-right top-menu top-right-menu">  
                    ...
                    <li class="dropdown">
                        ...
                        <ul style="overflow: hidden;" class="dropdown-menu extended fadeInUp animated nicescroll" tabindex="5001">
                            ...
                            <li>
                                <a href="#">
                                    <span class="pull-left"><img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar-2.jpg" class="img-circle thumb-sm m-r-15" alt="img"></span>
                            ...
                            <li>
                                <a href="#">
                                    <span class="pull-left"><img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar-3.jpg" class="img-circle thumb-sm m-r-15" alt="img"></span>
                                    <span class="block"><strong>John smith</strong></span>
                            ...
                            <li>
                                <a href="#">
                                    <span class="pull-left"><img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/avatar-4.jpg" class="img-circle thumb-sm m-r-15" alt="img"></span>
                                    <span class="block"><strong>John smith</strong></span>
                    ...
                    <!-- Notification -->
                    <li class="dropdown">
                    	<a href="<?php echo urlHome(); ?>" title="Trang Chủ">
                            <i class="fa fa-home"></i>
                            <span>Home</span>
                        </a>
                        <a href="<?php echo urlAdminLogout(); ?>" title="Đăng Xuất">
                    ...
                    <li class="dropdown text-center">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="<?php echo userImg(); ?>" class="img-circle profile-img thumb-sm">
                            <span class="username"><?php echo userFullname(); ?> </span> <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu extended pro-menu fadeInUp animated" tabindex="5003" style="overflow: hidden; outline: none;">
                            <li><a href="<?php echo urlAdminUserEdit().'user_id='.userId();?>"><i class="fa fa-briefcase"></i>Profile</a></li>
                            <li><a href="<?php echo urlAdminSettingEdit();?>"><i class="fa fa-cog"></i> Settings</a></li>
                            <li><a href="#"><i class="fa fa-bell"></i> Friends <span class="label label-info pull-right mail-info">5</span></a></li>
                            <li><a href="<?php echo urlAdminLogout();?>"><i class="fa fa-sign-out"></i> Log Out</a></li>
                        </ul>
                    </li>
