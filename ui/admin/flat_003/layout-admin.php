...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <!-- Bootstrap 3.3.4 -->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap.css" rel="stylesheet" type="text/css">    
    <!-- FontAwesome 4.3.0 -->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/font-awesome.css" rel="stylesheet" type="text/css">
    <!-- Ionicons 2.0.0 -->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/ionicons.css" rel="stylesheet" type="text/css">    
    <!-- Theme style -->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/AdminLTE.css" rel="stylesheet" type="text/css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins 
         folder instead of downloading all of them to reduce the load. -->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/_all-skins.css" rel="stylesheet" type="text/css">
    <!-- iCheck -->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/blue.css" rel="stylesheet" type="text/css">
    <!-- Morris chart -->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/morris.css" rel="stylesheet" type="text/css">
    <!-- jvectormap -->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery-jvectormap-1.css" rel="stylesheet" type="text/css">
    <!-- Date Picker -->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/datepicker3.css" rel="stylesheet" type="text/css">
    <!-- Daterange picker -->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/daterangepicker-bs3.css" rel="stylesheet" type="text/css">
    <!-- bootstrap wysihtml5 - text editor -->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap3-wysihtml5.css" rel="stylesheet" type="text/css">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="https://almsaeedstudio.com/themes/AdminLTE/index2.html" class="logo">
          ...
          -->
          <span class="logo-mini"><img src="<?php echo urlImgStoreLogo(); ?>" height="32" width="32"/></span>
          <!-- logo for regular state and mobile devices -->
<!--           <span class="logo-lg"><b>Admin</b></span> -->
		  <span class="logo-lg"><img src="<?php echo urlImgStoreLogo(); ?>" height="32" width="32"/></span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <div style="position: relative; overflow: hidden; width: auto; height: 200px;" class="slimScrollDiv"><ul style="overflow: hidden; width: 100%; height: 200px;" class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/user2-160x160.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Support Team
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/user3-128x128.jpg" class="img-circle" alt="user image">
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/user4-128x128.jpg" class="img-circle" alt="user image">
                          </div>
                          <h4>
                            Developers
              ...
              <li class="dropdown tasks-menu">
                <a href="<?php echo urlHome();?>" title="Trang Chủ" class="dropdown-toggle" data-toggle="dropdown">
...
<!--                   <span class="label label-danger">9</span> -->
        ...
        <section style="height: auto;" class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="<?php echo urlAdminDashboard() ?>">
            ...
            <li>
              <a href="<?php echo urlAdminModule(); ?>">
                <i class="fa fa-puzzle-piece fa-fw"></i> <span>Modules</small>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
    ...
    <!-- jQuery 2.1.4 -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jQuery-2.js"></script>
    <!-- jQuery UI 1.11.4 -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery-ui.js" type="text/javascript"></script>
    <!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
    <script>
      $.widget.bridge('uibutton', $.ui.button);
    </script>
    <!-- Bootstrap 3.3.2 JS -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap.js" type="text/javascript"></script>    
    <!-- Morris.js charts -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/raphael-min.js"></script>
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/morris.js" type="text/javascript"></script>
    <!-- Sparkline -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery.js" type="text/javascript"></script>
    <!-- jvectormap -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery-jvectormap-1.js" type="text/javascript"></script>
    ...
    <!-- daterangepicker -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/moment.js" type="text/javascript"></script>
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/daterangepicker.js" type="text/javascript"></script>
    <!-- datepicker -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap-datepicker.js" type="text/javascript"></script>
    <!-- Bootstrap WYSIHTML5 -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap3-wysihtml5.js" type="text/javascript"></script>
    <!-- Slimscroll -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery_002.js" type="text/javascript"></script>
    <!-- FastClick -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/fastclick.js"></script>
    <!-- AdminLTE App -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/app.js" type="text/javascript"></script>    
    
    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/dashboard.js" type="text/javascript"></script>    
    
    <!-- AdminLTE for demo purposes -->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/demo.js" type="text/javascript"></script>
