...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!--Open Sans Font [ OPTIONAL ] -->
     <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/css" rel="stylesheet">


    <!--Bootstrap Stylesheet [ REQUIRED ]-->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap.min.css" rel="stylesheet">


    <!--Nifty Stylesheet [ REQUIRED ]-->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/nifty.min.css" rel="stylesheet">

    
    <!--Font Awesome [ OPTIONAL ]-->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/font-awesome.min.css" rel="stylesheet">


    <!--Animate.css [ OPTIONAL ]-->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/animate.min.css" rel="stylesheet">


    <!--Morris.js [ OPTIONAL ]-->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/morris.min.css" rel="stylesheet">


    <!--Switchery [ OPTIONAL ]-->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/switchery.min.css" rel="stylesheet">


    <!--Bootstrap Select [ OPTIONAL ]-->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap-select.min.css" rel="stylesheet">


    <!--Demo script [ DEMONSTRATION ]-->
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/nifty-demo.min.css" rel="stylesheet">
    ...
    <link href="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/pace.min.css" rel="stylesheet">
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/pace.min.js"></script>
			...
			<div id="navbar-container" class="boxed">
				...
				<div class="navbar-header">
					<a href="http://www.themeon.net/nifty/v2.2.3/index.html" class="navbar-brand">
						<img src="<?php echo urlImgStoreLogo(); ?>" alt="Nifty Logo" class="brand-icon">
				...
				<div class="navbar-content clearfix">
					<ul class="nav navbar-top-links pull-left">
									...
									<div class="nano-content" tabindex="0" style="right: -17px;">
										<ul class="head-list">
											...
											<li>
												<a href="http://www.themeon.net/nifty/v2.2.3/index.html#" class="media">
													<div class="media-left">
														<img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/av2.png" alt="Profile Picture" class="img-circle img-sm">
													</div>
											...
											<li>
												<a href="http://www.themeon.net/nifty/v2.2.3/index.html#" class="media">
													<div class="media-left">
														<img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/av4.png" alt="Profile Picture" class="img-circle img-sm">
													</div>
													<div class="media-body">
											...
											<li>
												<a href="http://www.themeon.net/nifty/v2.2.3/index.html#" class="media">
													<div class="media-left">
														<img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/av3.png" alt="Profile Picture" class="img-circle img-sm">
													</div>
													<div class="media-body">
											...
											<li>
												<a href="http://www.themeon.net/nifty/v2.2.3/index.html#" class="media">
													<div class="media-left">
														<img src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/av6.png" alt="Profile Picture" class="img-circle img-sm">
													</div>
													<div class="media-body">
						...
						<li class="mega-dropdown">
							<a href="<?php echo urlHome();?>" title="Trang Chủ" class="mega-dropdown-toggle">
<!-- 								<i class="fa fa-th-large fa-lg"></i> -->
						...
						<li id="dropdown-user" class="dropdown">
							<a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
								<span class="pull-right">
									<img class="img-circle img-user media-object" src="<?php echo userImg(); ?>" alt="<?php echo userFullname();?>">
								</span>
								<div class="username hidden-xs"><?php echo userFullname();?></div>
							</a>
						</li>

						<li>
							<a id="" class="" href="<?php echo urlAdminLogout(); ?>">
								...
								<ul id="mainnav-menu" class="list-group">
									...
									<li>
										<a href="http://www.themeon.net/nifty/v2.2.3/index.html#" data-original-title="" title="">
											...
											<span class="menu-title">Doanh Số</span>
											<i class="arrow"></i>
										</a>
									...
									<li class="active-link">
										<a href="<?php echo urlAdminDashboard(); ?>" data-original-title="" title="">
									...
									<!--Menu list item-->
									<li>
										<a href="<?php echo urlAdminModule();?>" data-original-title="" title="">
								...
								<div class="tab-pane fade in active" id="demo-asd-tab-1">
									...
									<div class="list-group bg-trans">
										<a href="http://www.themeon.net/nifty/v2.2.3/index.html#" class="list-group-item">
											<div class="media-left">
												<img class="img-circle img-xs" src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/av2.png" alt="Profile Picture">
											</div>
											<div class="media-body">
										...
										<a href="http://www.themeon.net/nifty/v2.2.3/index.html#" class="list-group-item">
											<div class="media-left">
												<img class="img-circle img-xs" src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/av4.png" alt="Profile Picture">
											</div>
											<div class="media-body">
										...
										<a href="http://www.themeon.net/nifty/v2.2.3/index.html#" class="list-group-item">
											<div class="media-left">
												<img class="img-circle img-xs" src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/av3.png" alt="Profile Picture">
											</div>
											<div class="media-body">
									...
									<div class="list-group bg-trans">
										<a href="http://www.themeon.net/nifty/v2.2.3/index.html#" class="list-group-item">
											<div class="media-left">
												<img class="img-circle img-xs" src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/av5.png" alt="Profile Picture">
											</div>
											<div class="media-body">
										...
										<a href="http://www.themeon.net/nifty/v2.2.3/index.html#" class="list-group-item">
											<div class="media-left">
												<img class="img-circle img-xs" src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/av6.png" alt="Profile Picture">
											</div>
											<div class="media-body">
    ...
    <!--jQuery [ REQUIRED ]-->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/jquery-2.1.1.min.js"></script>


    <!--BootstrapJS [ RECOMMENDED ]-->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap.min.js"></script>


    <!--Fast Click [ OPTIONAL ]-->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/fastclick.min.js"></script>

    
    <!--Nifty Admin [ RECOMMENDED ]-->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/nifty.min.js"></script>


    <!--Morris.js [ OPTIONAL ]-->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/morris.min.js"></script>
    ...
    <!--Skycons [ OPTIONAL ]-->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/skycons.min.js"></script>


    <!--Switchery [ OPTIONAL ]-->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/switchery.min.js"></script>


    <!--Bootstrap Select [ OPTIONAL ]-->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/bootstrap-select.min.js"></script>


    <!--Demo script [ DEMONSTRATION ]-->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/nifty-demo.min.js"></script>


    <!--Specify page [ SAMPLE ]-->
    <script src="<?php echo URL_UI_ADMIN_THEMES;?>layout-admin_files/dashboard.js"></script>
