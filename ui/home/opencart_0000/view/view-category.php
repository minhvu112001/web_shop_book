<div class="container">
  ...
  <div class="row">
    ...
    <div id="content" class="col-sm-9">
      ...
      <div class="row">
        ...
        <div class="col-md-3 text-right">
          <select id="input-sort" class="form-control" onchange="location = this.value;">
            <?php foreach ($book_sorts as $sorts) { ?>
          ...
          <div class="book-thumb">
            ...
            <div>
              ...
              <div class="button-group">
                ...
                <button type="button" data-toggle="tooltip" title="<?php echo 'Whishlist'; ?>" onclick="wishlist.add('<?php echo $book['book_id']; ?>');"><i class="fa fa-heart"></i></button>
                <button type="button" data-toggle="tooltip" title="<?php echo 'So sánh sản phẩm'; ?>" onclick="compare.add('<?php echo $book['book_id']; ?>');"><i class="fa fa-exchange"></i></button>
              </div>
            </div>
          </div>
        </div>
      ...
      <?php } ?>
      <?php if (!$categories && !$booksByCategory) { ?>
