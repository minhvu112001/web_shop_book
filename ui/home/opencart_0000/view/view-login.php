<div class="container">
  <ul class="breadcrumb">
        ...
        <li><a href="<?php echo urlLogin(); ?>">Đăng nhập</a></li>
      </ul>
      <div class="row">                <div id="content" class="col-sm-9">      <div class="row">
        <div class="col-sm-6">
          <div class="well">
            ...
            <a href="<?php echo urlRegister(); ?>" class="btn btn-primary">Tiếp tục</a></div>
        </div>
        <div class="col-sm-6">
          <div class="well">
            ...
            <form action="<?php echo urlLogin(); ?>" method="post" enctype="multipart/form-data">
