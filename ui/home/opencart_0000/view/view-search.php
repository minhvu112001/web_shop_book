<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <br />
      <div class="row">
        <?php foreach ($booksSearched as $book) { ?>
        <div class="book-layout book-list col-xs-12">
          <div class="book-thumb">
            ...
            <div class="button-group">
              ...
              <button type="button" data-toggle="tooltip" title="So sánh" onclick="compare.add('<?php echo $book['book_id']; ?>');"><i class="fa fa-exchange"></i></button>
            </div>
          </div>
        </div>
        <?php } ?>
