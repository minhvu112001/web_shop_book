...
<div style="position:absolute;display:block;background:url('/<?php echo APP?>/themes/framework/jssor/22.2.8/img/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
</div>
