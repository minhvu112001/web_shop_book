...
<ul class="sf-menu">
	...
	<li>
		...
		<ul class="sf-mega-section">
			<li>
			<a class="screenshot1" href="#route=book/category&amp;path=57_30">Ctetur adipisicing </a>
			</li>
			<li>
				<a class="screenshot1" href="#route=book/category&amp;path=57_29">Lorem ipsum dolor</a>
			</li>
			<li class="">
				<a class="screenshot1 sf-with-ul" href="#route=book/category&amp;path=57_28">Sit amet conse <i class="fa fa-angle-right fa-fw"></i></a>
				<ul style="display: none;">
					<li>
					<a href="#route=book/category&amp;path=57_28_36">Dolore magna aliqua</a>
					</li>
					<li>
					<a href="#route=book/category&amp;path=57_28_35">Ut labore et </a>
					</li>
				</ul>
			</li>
			<li>
			<a class="screenshot1" href="#route=book/category&amp;path=57_32">Tmpor incididunt </a>
			</li>
		</ul>
</div>
</li>
