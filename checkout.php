...
{ 
	...
	$web_content = DIR_UI_HOME_THEMES."view/view-checkout-success.php";
...
// Kiểm tra xem trong giỏ có hàng không và trong kho còn hàng không
// nếu không thì điều hướng sang checkout/cart.php
// @todo nên gửi thông báo sang bên view để họ biết tình trạng.

if( !cartHasBooks() || (!cartHasStock() && settings('config_stock_checkout')) )
{
	header ("location: ".urlShoppingCart());
	die();
}
...
$web_content = DIR_UI_HOME_THEMES."view/view-checkout.php";
