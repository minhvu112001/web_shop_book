...
foreach ($images as $image) {
			...
			if (is_dir($image)) {
				...
				$manager_images[] = array(
					...
					'href'  => urlAdminFilemanager().'?directory=' . urlencode(utf8_substr($image, utf8_strlen(DIR_IMAGE . 'catalog/'))) . $url
				);
...
$manager_parent = urlAdminFilemanager() . $url;
...
$manager_refresh = urlAdminFilemanager() . $url;

// Paging
$url = urlAdminFilemanager().'?';
...
include_once DIR_UI."admin/view/view-filemanager.php";