...
$url_delete   = urlAdminOrderDelete().$url;
...
foreach ($results as $result) 
{
			$orders[] = array(
				...
				'view'          => urlAdminOrderInfo() . '?order_id=' . $result['order_id'] . $url,
				'delete'        => urlAdminOrderDelete() . '?order_id=' . $result['order_id'] . $url
			);
}
 ...
 */		
$sort_order         = urlAdminOrder() . '?sort=o.order_id' . $url;
$sort_customer      = urlAdminOrder() . '?sort=customer_id' . $url;
$sort_status        = urlAdminOrder() . '?sort=status' . $url;
$sort_total         = urlAdminOrder() . '?sort=o.total' . $url;
$sort_date_added    = urlAdminOrder() . '?sort=o.date_added' . $url;
...
paginate($order_total, $page,settings('config_limit_admin'), urlAdminOrder().$url);
